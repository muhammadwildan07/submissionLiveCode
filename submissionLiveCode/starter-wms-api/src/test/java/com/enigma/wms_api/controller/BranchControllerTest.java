...
public class BranchControllerTest {
    ...
    public void testCreateBranch() throws Exception {
        ...
        request.put("phoneNumber", "0812344ds1234");
    ...
    public void testUpdateBranch() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("branchId", "4a517ec4-1f4e-4070-a3ee-3b9eb848e2bb");
        request.put("branchName", "Cilandak KKO");
        request.put("branchCode", "ranchCode");
    ...
    public void testDeleteBranch() throws Exception {
        mockMvc.perform(delete("/api/branch/" + "ae51966e-cf15-4c4a-a3ef-fdb4b077b0fb").accept(MediaType.APPLICATION_JSON_VALUE))
                .andExpectAll(status().isOk())
                .andDo(result -> {
                    String jsonString = result.getResponse().getContentAsString();
                    Map<String, Object> mapResponse = objectMapper.readValue(jsonString, new TypeReference<>() {
